...
#game over is location has a bomb
#if it's not a bomb, dig recursively until is bomb, and if bomb not find, 
#declares Win or End game!

#import functions
import random #decided to use the random() module to implement pseudo-random number generators for various distributions
import re #The re.search() method takes a regular expression pattern and a string and searches for that pattern within the string
...
#######################################################
    ...
    def assign_values_to_board(self):
        # assign a number 0-8 to all empty spaces
...
def play(dim_size=10, num_bombs=10):
    ...
    while len(board.dug) < board.dim_size ** 2 - num_bombs:
        ...
        # if it's valid, we continue to dig
